...
if(isset($_POST['cipi']))
{
	...
	} else 
	{
		...
		{
			$Jeu = "Votre processeur fera tourner le jeu en parametre minimal.";
			$processeur_ok = "Votre processeur fera tourner le jeu en parametre minimal.";
		} else
		{
			$Jeu = "Votre processeur ne fera pas tourner le jeu en parametre minimal.";
			$processeur_ok = "Votre processeur ne fera pas tourner le jeu en parametre minimal.";
		}
		...
		{
			$Jeu = $Jeu ." Votre carte graphique fera tourner le jeu en parametre minimal.";
			$carte_graphique_ok = "Votre carte graphique fera tourner le jeu en parametre minimal.";
		} else
		{
			$Jeu = $Jeu ." Votre carte graphique ne fera pas tourner le jeu en parametre minimal.";
			$carte_graphique_ok = "Votre carte graphique ne fera pas tourner le jeu en parametre minimal.";
		}
		if($_SESSION['user_ram'] >= $game_min_ram)
		{
			$Jeu = $Jeu ." Vous disposez de suffisament de ram pour faire tourner le jeu en parametre minimal.";
			$ram_ok = "Vous disposez de suffisament de ram pour faire tourner le jeu en parametre minimal.";
		} else
		{
			$Jeu = $Jeu ." Vous ne disposez pas de suffisament de ram pour faire tourner le jeu en parametre minimal.";
			$ram_ok = "Vous ne disposez pas de suffisament de ram pour faire tourner le jeu en parametre minimal.";
		}
